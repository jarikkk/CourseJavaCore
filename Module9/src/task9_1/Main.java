...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        set.add(new Order(2, 1000, Currency.USD, "Lenovo", "Identificator2", new User(2, "Jack", "Jackson", "Kiev", 1000000)));
        set.add(new Order(3, 600000, Currency.UAH, "Sumsung", "Identificator3", new User(3, "Jack", "Jackson", "Kiev", 700000)));
